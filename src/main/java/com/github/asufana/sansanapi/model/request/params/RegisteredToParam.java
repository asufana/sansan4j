 ...
 * 名刺登録⽇時（省略時：現在時刻）
 */
public class RegisteredToParam {
    public static final String TODAY = new RegisteredToParam(toDateFormatString(new DateMidnight())).toString();
    public static final String TOMMOROW = new RegisteredToParam(toDateFormatString(new DateMidnight().plusDays(1))).toString();
    ...
    public RegisteredToParam(String value) {
